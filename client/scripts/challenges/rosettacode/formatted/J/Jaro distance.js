...
/// <dl class="rosetta__description-list"><dt class="rosetta__description-title">;Definition</dt></dl><p class="rosetta__paragraph">The Jaro distance  $d_j$  of two given strings  $s_1$  and  $s_2$  is</p><p class="rosetta__paragraph"><span class="rosetta__text--indented"> $d_j = \left\{</span></p><p class="rosetta__paragraph">\begin{array}{l l}</p>
/// <p class="rosetta__paragraph">0 & \text{if }m = 0\\</p>
/// <p class="rosetta__paragraph">\frac{1}{3}\left(\frac{m}{|s_1|} + \frac{m}{|s_2|} + \frac{m-t}{m}\right) & \text{otherwise} \end{array} \right.$</p><p class="rosetta__paragraph">Where:</p><ul class="rosetta__unordered-list"><li class="rosetta__list-item--unordered">$m$  is the number of <span class="rosetta__text--italic">matching characters</span>;</li>
